...
> No nosso caso não adicionamos o endereço do Gateway nos PC e ao realizar os teste, todos os PCs se comunicaram, ** isso acontece porque todos os PCs estão na mesma rede**.
